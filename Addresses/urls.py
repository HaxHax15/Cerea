...
urlpatterns=[
    ...
    url(r'^countries/(?:(?P<country_id>\d+)/edit/)?$',views.editcountry, name='countries'),
    ...
    url(r'^cities/(?:(?P<city_id>\d+)/edit/)?$',views.editcity, name='cities'),
    url(r'^streets/(?:(?P<street_id>\d+)/)?$',views.streets, name='streets'),
    url(r'^streets/(?:(?P<street_id>\d+)/edit/)?$',views.editstreet, name='streets'),
    url(r'^houses/(?:(?P<house_id>\d+)/)?$',views.houses, name='houses'),
    url(r'^houses/(?:(?P<house_id>\d+)/edit/)?$',views.edithouse, name='houses'),
